...
function sendButton_onclick() {
    var inputMsgBox = document.getElementById("inputMsgBox"); // jQuery: $('#inputMsgBox')
    if (inputMsgBox == null || inputMsgBox.value == null || inputMsgBox.value.length == 0) {
        return false;
    }
    
    var chatBoxArea = document.getElementById("chatBoxArea"); // jQuery: $('#chatBoxArea')
    ...
    var msg = {}; // '"{\"key\": " + "\"value\"}"'
    msg.from = uid;
    msg.to = document.getElementById("to").value; // jQuery: $('#to').val();
